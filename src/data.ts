...
export const COURSES: Course[] = [
  {
    ...
    link: 'https://drive.google.com/file/d/1_3d2kPGeHEf_S29RpnuADV8VbQdh3CE1/view?usp=sharing',
    type: 'external',
    category: 'Khác',
  },
    {
    ...
    link: 'https://drive.google.com/file/d/1E51HOUIqmVS4nWwGZRxkmAkD3kiNCRDl/view?usp=drive_link',
    type: 'external',
    category: 'Kỹ năng',
  },
    {
    id: 'shcd',
    title: 'Tài liệu SHCD UEH',
    hashtags: ['shcd', 'key'],
    link: 'https://drive.google.com/drive/folders/1kc62pDdz37TbKsqMsxrpK3h2t-vud2EI?usp=drive_link',
    type: 'external',
    category: 'Khác',
  },
    {
    id: 'shcd',
    title: 'TÀI LIỆU SHCD UEH năm 3 Liên tục cập nhật - Q-ACADEMY',
    hashtags: ['shcd', 'key'],
    link: 'https://drive.google.com/file/d/1M4-90mDrj2n5LOivgrD_v4_rijhr0MYw/view?usp=sharing',
    type: 'external',
    category: 'Khác',
  },
    {
    ...
    hashtags: ['HSK', 'Tiếng Trung'],
    link: 'https://drive.google.com/drive/u/0/folders/1NOitkzhianM-JI34snbwqzRUcdTTzg1p?fbclid=IwdGRjcARkylRleHRuA2FlbQExAHNydGMGYXBwX2lkCjY2Mjg1NjgzNzkAAR61gEkrAigwTtyZXzAfrAF6iVj6Hc8AyuDOnRhUEXEg7iJhYykS7FcjGbzGpg_aem_EFqdIEuS4wY7rbmGj-ooAg',
    type: 'external',
    category: 'Kỹ năng',
  },
    {
    id: 'chinese 1',
    title: 'Cẩm nang luyện thi HSK3',
    hashtags: ['HSK'],
    link: 'https://drive.google.com/file/d/1Se3u07OsUKoCdFs0uHbllN1gcM6wvYDe/view?usp=drive_link',
    type: 'external',
    category: 'Kỹ năng',
  },
  {
